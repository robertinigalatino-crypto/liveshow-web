...
export function ShowsGrid({ shows = [] }: ShowsGridProps) {
  ...
  return (
    <section id="shows" className="relative py-24 overflow-hidden bg-noise">
      {/* Background */}
                ...
                <CardContent className="p-5 space-y-4">
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-semibold text-foreground">{show.price}</span>
                    </div>
                  </div>
                  ...
                  >
                    <Link href={show.ticket_url} target="_blank">
